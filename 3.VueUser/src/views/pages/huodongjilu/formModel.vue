	...
	<div class="app-contain" :style='{"padding":"20px 20px","margin":"20px auto 40px","alignItems":"flex-start","flexWrap":"wrap","background":"#fff","display":"flex","width":"1200px","position":"relative","justifyContent":"space-between"}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">参与时长</div>
					<div  class="info_text" >{{detail.canyushizhang}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">完成任务</div>
					<div  class="info_text" >{{detail.wanchengrenwu}}</div>
				</div>
				<div class="btn_view">
					<el-button v-if="centerType&&(detail.ispay=='未支付'||!detail.ispay)&&btnFrontAuth('huodongjilu','支付')" class="approval_btn" @click="payClick">支付</el-button>
					<el-button class="edit_btn" v-if="centerType&&btnAuth('huodongjilu','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('huodongjilu','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
