				...
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="报名时间" prop="baomingshijian">
							<el-input class="list_inp" v-model="form.baomingshijian" placeholder="报名时间"
								 type="text" 								:readonly="!isAdd||disabledForm.baomingshijian?true:false" />
						</el-form-item>
					</el-col>
					...
					<el-col :span="12">
						<el-form-item label="参与时长" prop="canyushizhang">
							<el-input class="list_inp" v-model="form.canyushizhang" placeholder="参与时长"
								 type="text" 								:readonly="!isAdd||disabledForm.canyushizhang?true:false" />
						</el-form-item>
					</el-col>

					<el-col :span="24">
						<el-form-item label="完成任务" prop="wanchengrenwu">
							<el-input v-model="form.wanchengrenwu" placeholder="完成任务" type="textarea"
							:readonly="!isAdd||disabledForm.wanchengrenwu?true:false"
							/>
						</el-form-item>
					</el-col>
				</el-row>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='canyushizhang'){
					form.value.canyushizhang = row[x];
					disabledForm.value.canyushizhang = true;
					continue;
				}
				if(x=='wanchengrenwu'){
					form.value.wanchengrenwu = row[x];
					disabledForm.value.wanchengrenwu = true;
					continue;
				}
			}
			if(row){
