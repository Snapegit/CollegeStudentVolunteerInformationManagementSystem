	...
	<div>
		<div class="forget_view">
			<el-form :model="forgetForm" class="forget_box">
				<div class="forget_title">大学生志愿者信息管理系统{{pageType==1?'找回密码':pageType==2?'输入密保':'重置密码'}}</div>
				<div class="tab_line">
					<div class="line"></div>
					<div class="num_line">
...
<style lang="scss" scoped>
	.forget_view {
		...
		background: url(http://clfile.zggen.cn/20240326/5e94dbdbec894f0c9a337726fb04501f.png);
		display: flex;
		min-height: 100vh;
		...
		.forget_box {
			...
			.forget_title {
				...
				color: #fff;
				background: url(http://clfile.zggen.cn/20240326/a4c54d03b7df48c7a4fa269a996ee699.png) no-repeat left center / 100% 100%;
				font-weight: 500;
				width: 100%;
				font-size: 16px;
				line-height: 50px;
