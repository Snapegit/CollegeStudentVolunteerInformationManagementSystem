		...
		<el-dialog v-model="formVisible" :title="formTitle" width="80%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" label-width="$template2.back.add.form.base.labelWidth" :rules="rules">
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="报名人数" prop="baomingrenshu">
							<el-input class="list_inp" v-model.number="form.baomingrenshu" placeholder="报名人数"
								 type="text" 								:readonly="!isAdd||disabledForm.baomingrenshu?true:false" />
						</el-form-item>
					</el-col>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='baomingrenshu'){
					form.value.baomingrenshu = row[x];
					disabledForm.value.baomingrenshu = true;
					continue;
				}
				if(x=='baomingshijian'){
